    ...
    <div class="container">
        ...
        <div class="logreg-box">
            ...
            <div class="form-box register">
                <form id="form-up" action="inscription_traitement.php" method="post">
                    <h2>Register</h2>
                    ...
                    <div class="input-box">
                        <span class="icon-input"><i class="ri-user-3-fill"></i></span>
                    ...
                    <div class="input-box">
                        ...
                        <input type="password" name="password" id="pass-up" required autocomplete="off">
                        <label>Password</label>
                    </div>

                    <div class="input-box">
                        <span class="icon-input"><i class='bx bxs-lock-alt' ></i></span>
                        <input type="password-retype" name="password_retype" id="pass-up" required autocomplete="off">
